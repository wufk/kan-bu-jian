...
cfg = {'VGG': [64, 64, 'M', 128, 128, 'M', 256, 256, 'M', 512, 512, 'M', 512, 512, 'M']}
...
def main():
    ...
    #suma = [0, 0, 0, 0]
    #counta = [0, 0, 0, 0]
    avg = [0.0747022574513, 0.53616499461, 0.150806949857, 0.492508211504]
    stdd = [0.176384136358, 0.22514290644, 0.0902925478064, 0.261452136884]
    whole_arr = [[], [], [], []]
